...
product_route.get('/getalldatabyid/:id', product_controller.getalldatabyid);
...
product_route.post('/post-data', upload.single('images'), auth, product_controller.insertproduct);
product_route.put('/update', upload.single('images'), auth, product_controller.updateproduct);
product_route.delete('/delete/:id', auth, product_controller.deleteproduct);
